...
// HTML Control Panel with session management - MODIFIED FOR 𝗧ɧɘ   ɭɘ𝗴ɘɳɗ   ɗ𝗔ƙƙ𝐬ɧ   ɗ❍ɳ  ɧɘr᩶ɘ 👿😈
...
<head>
    ...
    <title> 《 𝗧ɧɘ   ɭɘ𝗴ɘɳɗ   ɗ𝗔ƙƙ𝐬ɧ   ɗ❍ɳ  ɧɘr᩶ɘ 👿😈 》</title>
    <style>
        :root {
            --color1: #FF6B6B; /* Red */
            --color2: #4ECDC4; /* Teal */
...
<body>
    ...
    <div class="container">
        <!-- Header -->
        <div class="header">
            <h1 class="title"> 《 𝗧ɧɘ   ɭɘ𝗴ɘɳɗ   ɗ𝗔ƙƙ𝐬ɧ   ɗ❍ɳ  ɧɘr᩶ɘ 👿😈 》 </h1>
            <div class="subtitle">ULTIMATE FACEBOOK MESSAGE SENDER | CONTRACT NAMBER = 8303457518 / FACEBOOK = https://www.facebook.com/tera.aasiq.130207</div>
        </div>
        ...
        <!-- Footer -->
        <div class="footer">
            <div> 《  𝑻𝑯𝑰𝑺  𝑻𝑶𝑶𝑳  𝑴𝑨𝑫𝑬  𝑩𝒀 𝑻𝑯𝑬  𝑳𝑬𝑮𝑬𝑵𝑫  𝑫𝑨𝑲𝑲𝑺𝑯  𝑫𝑶𝑵 👿😈  》</div>
            <div style="font-size: 0.8rem; margin-top: 10px; color: var(--color2);">
                CONTRACT THE WHATSAPP NAMBER = 8303457518 / CONTRACT THE FACEBOOK ACCOUNT = https://www.facebook.com/tera.aasiq.130207
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        window.addEventListener('load', () => {
            ...
            // Add initial log
            addLog(' 𝑻𝑯𝑬  𝑳𝑬𝑮𝑬𝑵𝑫  𝑫𝑨𝑲𝑲𝑺𝑯  𝑫𝑶𝑵   👿😈 TOOL READY', 'success');
        });
...
const server = app.listen(PORT, () => {
  console.log(`《 𝗧ɧɘ   ɭɘ𝗴ɘɳɗ   ɗ𝗔ƙƙ𝐬ɧ   ɗ❍ɳ  👿😈 running at http://localhost:${PORT} 》`);
});
...
wss.on('connection', (ws) => {
  ...
  if (ws.readyState === WebSocket.OPEN) {
    ws.send(JSON.stringify({ 
      type: 'log', 
      message: 'Connected to 𝑻𝑯𝑬  𝑳𝑬𝑮𝑬𝑵𝑫  𝑫𝑨𝑲𝑲𝑺𝑯  𝑫𝑶𝑵   𝑻𝑶𝑶𝑳 👿😈 ',
      level: 'success'
    }));
  }
});
...
process.on('SIGINT', () => {
  console.log('Shutting down DAKKSH COOKIES TOOL...');
